...
<style>
  ...
  .search-tab.active { color: #059669; border-bottom-color: #059669; font-weight: 500; }
  ...
  .semantic-result a { text-decoration: none; color: #059669; font-size: 0.9375rem; }
  ...
  [data-theme="dark"] .search-tab.active { color: #34d399; border-bottom-color: #34d399; }
  [data-theme="dark"] .semantic-result { border-bottom-color: #1f2937; }
  [data-theme="dark"] .semantic-result a { color: #34d399; }
  ...
  #semantic-input:focus { border-color: #059669; }
  [data-theme="dark"] #semantic-input { background: #1f2937; border-color: #4b5563; color: #f3f4f6; }
  [data-theme="dark"] #semantic-input:focus { border-color: #34d399; }
</style>
