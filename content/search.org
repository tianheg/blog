...
<style>
  ...
  @media (prefers-color-scheme: dark) {
    :root { --pagefind-ui-border: #374151; }
    ...
    /* Pagefind UI */
    .pagefind-ui__drawer { color: #d1d5db; }
    .pagefind-ui__search-clear { background: #374151; color: #d1d5db; }
    .pagefind-ui__message { color: #9ca3af; }
    .pagefind-ui__result-title a { color: #60a5fa; }
    .pagefind-ui__result-title a:hover { color: #93c5fd; }
    .pagefind-ui__result-excerpt { color: #d1d5db; }
    .pagefind-ui__result-excerpt mark { background: #3b3b1f; color: #fef08a; }
    .pagefind-ui__result { border-top-color: #374151; }
    .pagefind-ui__result:last-of-type { border-bottom-color: #374151; }
    .pagefind-ui__result-nested { border-color: #374151; }
    .pagefind-ui__button { background: #1f2937; color: #d1d5db; border-color: #4b5563; }
    .pagefind-ui__button:hover { background: #374151; }
    .pagefind-ui__button:focus { border-color: #60a5fa; }
    .pagefind-ui__button.pagefind-ui__button--disabled { background: #111827; color: #6b7280; border-color: #374151; }
    .pagefind-ui__result-thumb { border-color: #374151; }
  }
</style>
