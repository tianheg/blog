...
一直以来都很想要一个域名邮箱，现在终于有了。域名地址：me@tianheg.xyz（已弃用，2023-07-27）。
...
Cloudflare 提供一种名为
[Email Routing](https://blog.cloudflare.com/introducing-email-routing/) 的服务，很久之前加入内测，今天可以使用了。它的作用和 Forward
