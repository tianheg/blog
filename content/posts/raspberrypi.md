---
title: '树莓派'
date: 2023-12-11T16:35:00+08:00
tags: ['技术']
---

我拥有的树莓派型号是 [3b](https://www.raspberrypi.com/products/raspberry-pi-3-model-b/)。

树莓派默认用户名 `pi` ，默认密码 `raspberry` 。

微雪墨水屏控制代码仓库（[GitHub](https://github.com/waveshareteam/e-Paper)）。

微雪2.7inch e-Paper HAT（2.7英寸电子墨水屏）文档（[Wiki](https://www.waveshare.net/wiki/2.7inch_e-Paper_HAT)）。
...
感谢 @guanqr 的《[树莓派利用水墨屏显示实时天气状况](https://guanqr.com/tech/computer/raspberry-pie-shows-the-weather-through-e-paper/)》。
...
感谢 [torfsen/python-systemd-tutorial](https://github.com/torfsen/python-systemd-tutorial)。
