...
很久以前遇到这个[^1]有趣的 CSS 效果——点击字母，就会发光。

[点这里查看 Glowing Text 交互效果](https://codepen.io/prathkum/pen/KKzdXpY)
...
> on which it is used.
>
> ------CSS Values and Units Module Level 3 标准[^5]
...
[^1]: [Glowing Text](https://codepen.io/prathkum/pen/KKzdXpY)

[^2]: [&lt;length&gt; - CSS | MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/length)

[^3]: [Viewport - MDN](https://developer.mozilla.org/en-US/docs/Glossary/Viewport)

[^4]: [position - CSS | MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/position#values)

[^5]: [Font-relative Lengths: the em, ex, ch, rem units](https://www.w3.org/TR/css3-values/#font-relative-lengths)

[^6]: <https://stackoverflow.com/a/61308622>

[^7]: [Browser compatibility - -webkit-tap-highlight-color - CSS: Cascading Style Sheets | MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-tap-highlight-color#browser_compatibility)
