...
date: 2022-11-14T21:57:00+08:00
tags: ['技术']
---
...
- 不同的
   ...
   等
- 背景图可以使用本地资源
- 使用 [Prism](https://prismjs.com/) 和
   [Shiki](https://github.com/shikijs/shiki)
   支持代码高亮；行高亮（单次、多步骤）
- 使用 [Monaco](https://github.com/Microsoft/monaco-editor)
   支持在线修改内容
...
- 支持 Diagrams，由 [Mermaid](https://mermaid-js.github.io/mermaid/)
   驱动
...
- 演示模式 Presenter Mode
- 支持绘图和注释
- 通过[扩展](https://marketplace.visualstudio.com/items?itemName=antfu.slidev)方便地在
