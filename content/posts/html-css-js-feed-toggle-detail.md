...
`setHTML`
目前还属于[实验特性](https://developer.mozilla.org/en-US/docs/Web/API/Element/setHTML)，Firefox
...
和 JavaScript
[`document.importNode()`](https://developer.mozilla.org/en-US/docs/Web/API/Document/importNode)[^1]。
...
[^1]: [Using innerHTML, and what are security concerns?](https://stackoverflow.com/a/47945729/12539782)
