...
date: 2023-04-05T11:31:00+08:00
tags: ['技术']
---

[The Mistakes I Made As a Beginner Programmer | by Samer Buna | EdgeCoders | Medium](https://medium.com/edge-coders/the-mistakes-i-made-as-a-beginner-programmer-ac8b3e54c312)
...
- 过度使用条件逻辑。你认为需要条件逻辑的大部分内容都可以在没有它的情况下完成。考虑所有的替代方案，并仅基于可读性选择。除非你能够进行度量，否则不要为性能进行优化。相关：避免使用[Yoda条件](https://en.wikipedia.org/wiki/Yoda_conditions)和条件语句内的赋值。
...
你需要识别自己的假设属于哪两个主要分类中的哪一个。不要写你今天不需要的代码。不要为未知的未来制定计划。
