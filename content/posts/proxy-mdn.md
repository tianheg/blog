...
MDN 全称 Mozilla Developer Network，这是它第二个名字[^1]。
...
和 [Express](https://expressjs.com/)，代码的主要部分。
...
[^1]: [MDN Web Docs - Wikipedia](https://en.wikipedia.org/wiki/MDN_Web_Docs)

[^2]: [Home · Cloudflare Docs](https://developers.cloudflare.com/)
