---
title: '如何构建网站'
date: 2023-08-12T06:03:00+08:00
tags: ['技术']
---
...
使用 [SVGO](https://github.com/svg/svgo) 优化 SVG（要安装 Node.js）（或者使用[SVGOMG](https://jakearchibald.github.io/svgomg/)）：

```bash
npx svgo --multipass icon.svg
```

使用 [Squoosh](https://squoosh.app/) 优化光栅图像：
...
- [How to Favicon in 2023: Six files that fit most needs—Martian Chronicles, Evil Martians’ team blog](https://evilmartians.com/chronicles/how-to-favicon-in-2021-six-files-that-fit-most-needs)
