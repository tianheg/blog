...
date: 2023-04-19T16:42:00+08:00
tags: ['技术']
---

我通过模仿、学习、试错，成功地将一个 Vue2 项目升级到 Vue3。

这个项目的最初想法来自 [lework/lemonitor](https://github.com/lework/lemonitor)，这个项目用到的主要技术有 Vue CLI、Vue Router、Vuex 和 Vue2。我对构建这个镜像站产生了兴趣，想了解具体实现，但不想继续使用 Vue2，最终决定把这个项目用 Vue3 实现。用到的主要技术有 Vite、Vue Router、Pinia 和 Vue3。Vite 替代 Vue CLI，Pinia 替代 Vuex，Vue 使用当前最新版本。
...
在定义 store 时，这里使用的是更灵活的 [Setup Stores](https://pinia.vuejs.org/core-concepts/#setup-stores) 写法。
