...
[refer](https://gohugo.io/hugo-pipes/transform-to-css/#options)

在第一个 transplier 中，因为默认的 libsass 已经被官方在 2020 年[宣布弃用](https://sass-lang.com/blog/libsass-is-deprecated)（Deprecated）。，根据 Hugo 文档，可供选择的只有 dart-sass-embedded。
...
- [Bundle Embedded Dart Sass into Hugo installation process](https://github.com/gohugoio/hugo/issues/8299) from Mar 5, 2021 to
- [通用的 Linux 安装 dart-sass-embedded 以及在 Hugo templates 中使用的方法](https://discourse.gohugo.io/t/first-stable-release-of-dart-sass-embedded/36911/2)
