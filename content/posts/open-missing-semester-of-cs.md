...
date: 2022-11-14T14:48:00+08:00
tags: ['公开课']
---
...
[imagemagick](https://en.wikipedia.org/wiki/ImageMagick) 提供。
...
find 更丰富的文件/目录查找工具。[fd](https://github.com/sharkdp/fd):
...
([documentation](https://vim.fandom.com/wiki/Search_and_replace)).
...
- [Vim Adventures](https://vim-adventures.com/) is a game to learn
   Vim
- [Vim Tips Wiki](https://vim.fandom.com/wiki/Vim_Tips_Wiki)
- [Vim Advent Calendar](https://web.archive.org/web/20220610123437/https://vimways.org/2019/) has various Vim tips
- [Vim Golf](http://www.vimgolf.com/) is
   [code golf](https://en.wikipedia.org/wiki/Code_golf), but where the
...
8. (Advanced) Convert XML to JSON
   ...
   look at the
   [macros](https://missing.csail.mit.edu/2020/editors/#macros)
