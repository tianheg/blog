...
- nginx-proxy：使用
  [docker-gen](https://github.com/nginx-proxy/docker-gen) 为 Docker
  Nginx 提供代理，[官网](https://github.com/nginx-proxy/nginx-proxy)
- Cache-Control：HTTP
  请求头，用于控制缓存，[文档](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cache-Control)
