...
date: 2023-03-29T08:06:00+08:00
tags: ['技术']
---
...
像 OpenAI 这样的公司花大量的时间和精力调整模型以改善输出。一支由人类标签员组成的军队对模型的输出进行 "打分"，而模型则不断学习和进化。
...
还需要提到一点：生成 50 行 HTML 代码和生成一个可以投入生产的 Web 应用程序之间有着巨大差异。像我的博客这样的小型应用程序有大约 65k 行代码，跨越 900 多个文件。这还不包括博客内容，只有 JS 和 TypeScript。
...
几周前，他在 YouTube 上发布了一个视频：[Disney Animator REACTS to AI Animation](https://www.youtube.com/watch?v=xm7BwEsdVbQ)。读完这篇文章后，他的观点对你来说很熟悉：他认为这些工具不是威胁，他认为这些工具可以提高动画师的工作效率，并带来更多的动画师工作。
