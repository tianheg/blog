...
本地运行的话，需要使用 `pip`，`pipenv` 命令。我的本地环境是 WSL2-Ubuntu20.04。我已经安装了最新版本的 pip，直接安装 pipenv 即可：
...
[错误地址1]: https://github.com/tianheg/tianheg/runs/1766834207?check_suite_focus=true#step:4:5
[错误地址2]: https://github.com/tianheg/tianheg/runs/1766683386?check_suite_focus=true#step:6:42
[了解更多]: https://crontab.guru/
