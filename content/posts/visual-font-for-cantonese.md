---
title: '粤语注音字体的使用'
date: 2023-05-10T16:06:00+08:00
tags: ['技术']
---

[Visual Fonts – Type Good Pictures](https://visual-fonts.com/)

在 [HackerNews](https://news.ycombinator.com/item?id=35867275) 网站看到这条，觉得新奇，于是进入网站。被美丽的注音字体所吸引，于是想要安装，下载字体后，按照我的 Arch Linux 的 [Wiki](https://wiki.archlinux.org/title/Fonts)，新建文件夹 `/usr/local/share/fonts/ttf` ，将字体文件 VF-Cantonese.ttf 放到文件夹中。

使用浏览器插件 Stylebot（或者 Stylus），导入下载文件中的 chrome-stylebot/stylebot_backup.json 文件，打开一个网页：[中文维基百科-香港繁体页](https://zh.wikipedia.org/zh-hk/Wikipedia:%E9%A6%96%E9%A1%B5)。如果文件设置的样式不够合适，可以自己调整：
...
该字体作者在「[Why a Font?](https://visual-fonts.com/canto/canto-why-font/)」页的一些话：
