...
Markdown
支持两种样式的标题，[Setext](https://docutils.sourceforge.io/mirror/setext.html)
和 [atx](http://www.aaronsw.com/2002/atx/)。
...
### 跨度元素（Span Elements） {#跨度元件span-elements}
#### 链接 {#链接}
...
This is [an example] [id](http://example.com/) reference-style link.
