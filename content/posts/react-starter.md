...
date: 2023-03-30T08:14:00+08:00
tags: ['技术']
---

[How to start a React Project in 2023](https://www.robinwieruch.de/react-starter/)

新 React 官方文档已经发布了，[推荐使用框架开启新项目，通过 Create React App 开启新项目的部分被删除](https://react.dev/learn/start-a-new-react-project)。
...
[Vite](https://vitejs.dev/) 比 create-react-app (CRA) 要快，前者用 [esbuild](https://esbuild.github.io/)，后者用 [webpack](https://webpack.js.org/)。
...
[Next.js](https://nextjs.org/) 是最成熟的 React 的框架，如果你想选择一个具备强观念的 React 框架，非它莫属。它有很多自己的设计（基于文件的路由），如果它不是你的菜，你可以选择 [Remix](https://remix.run/) ，Remix 完全遵循现行 Web 标准。
...
[Astro](https://astro.build/) 允许开发者创建专注内容的网站。
...
- [Parcel](https://parceljs.org/) 替代 Vite
...
- [Monorepos](https://www.robinwieruch.de/javascript-monorepos/)
- [create-t3-app](https://create.t3.gg/) for [tRPC](https://www.robinwieruch.de/react-trpc/)
