...
2. 如果没有 Cloudflare 账户，点击[[https://dash.cloudflare.com/sign-up][创建]]，登录后，找到侧边栏的 Pages，点击 Create a project，点击 Connect to Git，之后安装 Cloudflare Pages GitHub App，选择第一步的仓库，之后回到 Cloudflare Pages Connect to Git，选择那个仓库，点击 Begin setup。
