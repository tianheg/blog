...
This script may not seem like much now, but before writing it, I was quite troubled, pondering how to solve the above problems. With the help of AI, I finally achieved my goal. When writing this script, I referred to [dgurns/magic-ai-box](https://github.com/dgurns/magic-ai-box) and used the REST API directly instead of Cloudflare's [official SDK](https://github.com/cloudflare/cloudflare-typescript).
