...
### 张云帆谈时间管理：知行合一的"合" {#张云帆时间管理}

**知行小酒馆 E110** （2023）嘉宾张云帆（前完美世界CEO）聊《芒格之道》时，提出了一个独特的时间管理框架。它与经典时间管理方法论不冲突，但提供了一个更底层的视角。

#### 时间颗粒度 {#时间颗粒度}

"时间颗粒度越细，你离世俗成功越近。"

大多数人感知和支配时间的最小单位是半天、一天；稍好一点的是小时；更精细的是 30 分钟、15 分钟。你以什么单位感知时间，就决定了你以什么精度使用时间。粗颗粒度的人，一个早上"反正还有时间"就滑过去了；细颗粒度的人，知道每一块时间对应什么产出。

这里的"世俗成功"并非狭义指财富，而是"把事做成"的能力——能在给定时间内按预期交付结果。

#### 三环闭环：记录 → 分析 → 反馈 {#三环闭环}

这三个环节缺一不可：

1. **记录** — 客观知道你实际把时间花在哪了。大多数人对自己时间去向的认知严重失真。
2. **分析** — 不是看了记录就完事。要问：这块时间花得值不值？有没有更高效的方式？
3. **反馈调整** — 根据分析结果重新安排。形成闭环。

这三步持续循环，时间精度才会越来越高。跟耗子叔说的"每周反思复盘"方向一致，但张云帆把它系统化为一个持续运转的闭环，而且强调第一步"记录"的客观性——没有数据，分析无从谈起。

#### 时间管理 = "合"（知行合一的新解） {#时间管理即合}
...
时间管理是把抽象道理翻译成具体日程的翻译器。你知道该做什么（知），也知道该怎么做（行），但如果你没在时间上安排出来，这两个就是空中楼阁。张云帆说这是多数人"懂了很多道理却过不好这一生"的真正原因——不是道理不对，是缺少"合"这一步。

#### 前提：对知识诚实 {#对知识诚实}

张云帆特别强调，时间管理不能独立于认知诚实来谈。如果你对自己不诚实——不知道就是不知道，假装懂了——你的时间安排就会建立在错误的前提上。花大量时间做错误的事情，时间管理越精细，错得越远。

所以时间管理的前置条件不是工具或方法，而是 **知道自己不知道什么** ，然后把时间花在补齐那些真缺口上。这一点与芒格的逆向排查法（[《穷查理宝典》——芒格的逆向排查法](./poor-charlies-almanack.org)）一脉相承——先搞清楚不能做什么，再安排该做什么。

#### 与张云帆其他观点的关联 {#张云帆其他关联}

- **能力圈** ：不要只在能力圈里找最大收益，要主动花时间扩大能力圈。以"钱为标准"选择永远在舒适圈内最大化收益，长远看会错失成长。
