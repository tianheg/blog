...
The Type ：[The Type](https://www.thetype.com/) 是一个中文字体设计博客，他们的文章能够帮助你很好地了解字体设计的基础、排版原理的基础以及一些历史背景，而且不失趣味性。推大家去看看他们整理的这份 [书单](https://thetype.com/booklist/)，以及 [基础文章汇总](https://thetype.com/basics/)，都是非常棒的入门文章，可以做为知识的巩固。

同时，他们也拥有一个名为《字谈字畅》的播客栏目，是目前唯一一档专注于字体的中文播客。《字谈字畅》是了解字体知识以及背后故事的好渠道。你可以在播客应用中搜索「字谈字畅」或访问 字谈字畅官网 进行收听。

justfont 博客：[justfont blog](https://blog.justfont.com/) 是之前提到的一家位于台湾的中文 Webfont 工作室。他们的博客有许多关于繁体中文字体设计的文章，文章内讨论的内容同样适用于简体中文的排版。justfont 的选题非常有趣，比如《筆畫都是選票：從字型設計看首長大選》《颱風天，談一下颱字的設計》等等。
...
- [Get Started with the Google Fonts API  |  Google Developers](https://developers.google.com/fonts/docs/getting_started?hl=en)
- <https://www.glyphrstudio.com/online/>
- [Web 中文字体应用指南 · Ruby China](https://ruby-china.org/topics/14005)
- <https://github.com/zenozeng/fonts.css>
- [赫蹏 - （hètí）是专为中文内容展示设计的排版样式增强。它基于通行的中文排版规范而来，可以为网站的读者带来更好的文章阅读体验。](https://github.com/sivan/heti)
...
4. 在 Web 中使用字体
  ...
  1. 字体性能
    ...
    - 移除不用的字符
      ...
      [生成 @font-face](https://transfonter.org/)
...
font [网页中文字体加载速度优化 - 字体分包](https://www.hehehai.cn/posts/chinese-web-font-optimize)
...
> <https://twitter.com/mrmrs_/status/775837789619417088>

[Moving to a system font stack in WordPress (how and why)](https://woorkup.com/system-font/)
