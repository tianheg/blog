...
title: MongoDB
status: draft
date: 2022-11-14T09:13:46+08:00
header: Tools
---

NoSQL 的面向文档的数据库。MongoDB 的数据存储的格式为 [BSON](https://bsonspec.org/)（a binary version of JSON）。

[MongoDB CRUD 概念](https://www.mongodb.com/docs/manual/core/crud/)
...
### 关系型数据库和 MongoDB 的对比
[重要官方文档](https://www.mongodb.com/docs/manual/reference/sql-comparison/)
...
2.  What does `it` do in the mongo shell?

Iterates through the cursor results

3.  Which of the following statements are true about the `mongo shell`?
...
先讲的是 [ObjectId](https://www.mongodb.com/docs/manual/reference/method/ObjectId/#objectid) 数据类型。
