...
title: Docker
status: draft
date: 2022-11-09T15:57:53+08:00
header: DevOps
---
...
### 入门指南
#### 什么是容器？
容器可以看作计算机的进程，但它与一般进程是隔离的。这种隔离策略使用了已经存在很多年的 Linux 内核的特性------命名空间[^5]和控制组 cgroups[^6]。
...
>
> -- Container Images: Architecture and Best Practices - Aqua[^8]
>
...
注意：不要在生产环境中使用环境变量，更安全的做法是使用 .env 之类的文件[^9]。
...
### 应用
- [Watchtower](https://containrrr.dev/watchtower/) 用于更新运行中的容器化应用
- [Portainer](https://www.portainer.io/) 用于可视化操作容器应用
...
```
   ...
   This command will delete all images that do not have at least one container associated with them [[2](https://stackoverflow.com/questions/32723111/how-to-remove-old-and-unused-docker-images)][[3](https://docs.docker.com/engine/manage-resources/pruning/)].
...
Learn more: 1. [Docker -- Removing Dangling and Unused Images - Baeldung](https://www.baeldung.com/ops/docker-remove-dangling-unused-images) 2. [How to remove old and unused Docker images - Stack Overflow](https://stackoverflow.com/questions/32723111/how-to-remove-old-and-unused-docker-images) 3. [Prune unused Docker objects | Docker Docs](https://docs.docker.com/engine/manage-resources/pruning/)

[^1]: <https://docs.docker.com/engine/install/linux-postinstall/#manage-docker-as-a-non-root-user>

[^2]: <https://docs.docker.com/engine/install/linux-postinstall/#configure-docker-to-start-on-boot>

[^3]: <https://docs.docker.com/config/daemon/systemd/>

[^4]: <https://docs.docker.com/engine/install/linux-postinstall/#configure-where-the-docker-daemon-listens-for-connections>

[^5]: <https://man7.org/linux/man-pages/man7/namespaces.7.html>

[^6]: <https://medium.com/@saschagrunert/demystifying-containers-part-i-kernel-space-2c53d6979504>

[^7]: <https://kubernetes.io/docs/concepts/containers/images/>
