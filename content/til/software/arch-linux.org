...
** System Management
:PROPERTIES:
:CUSTOM_ID: system-management
:END:
*** Kernel Downgrade
:PROPERTIES:
:CUSTOM_ID: kernel-downgrade
:END:
...
** Hardware & Drivers
:PROPERTIES:
:CUSTOM_ID: hardware-drivers
:END:
*** Screen Flickering (Intel GPU)
:PROPERTIES:
:CUSTOM_ID: screen-flickering
:END:
...
:PROPERTIES:
:CUSTOM_ID: desktop-apps
:END:
*** Wayland Setup
:PROPERTIES:
:CUSTOM_ID: wayland-setup
:END:
...
:PROPERTIES:
:CUSTOM_ID: building-custom-images
:END:
