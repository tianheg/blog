...
可在[标准]([[https://html.spec.whatwg.org/multipage/semantics.html#the-html-element)中读到更多关于]] `lang` 的内容。在 <abbr title="Internet Assigned Numbers Authority">IANA</abbr> 可以看到[[https://www.iana.org/assignments/language-subtag-registry/language-subtag-registry][语言代码列表]]。
...
1. [[https://markdotto.com/2012/02/16/scope-css-classes-with-prefixes/][Scope CSS classes with prefixes | @mdo]]
2. [[https://markdotto.com/2012/03/02/stop-the-cascade/][Stop the cascade | @mdo]]
