...
:PROPERTIES:
:CUSTOM_ID: useful-aboutconfig-settings
:END:
...
*** TabMixPlus
:PROPERTIES:
:CUSTOM_ID: tabmixplus
:END:
https://github.com/onemen/TabMixPlus

** User Styles
:PROPERTIES:
:CUSTOM_ID: user-styles
:END:
*** Hide Tabbar (userChrome.css)
:PROPERTIES:
:CUSTOM_ID: hide-tabbar
:END:
...
*** Network Errors
:PROPERTIES:
:CUSTOM_ID: network-errors
:END:
- `NS_ERROR_CORRUPTED_CONTENT` - 内容损坏错误

*** PR_END_OF_FILE_ERROR
:PROPERTIES:
:CUSTOM_ID: pr-end-of-file-error
:END:
