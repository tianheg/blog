...
- [[https://www.dnssec.net/][DNSSEC - DNS Security Extensions]]
- [[http://idsa.irisa.fr/index.php?page=kro&lang=en][Projet IDsA]]
- [[https://web.archive.org/web/20080813191530/http://ietfreport.isoc.org/ids-wg-dnsext.html][Internet Society (ISOC) Publications: Internet Report]]
- [[https://www.net-dns.org/][Net::DNS]]
- [[https://web.archive.org/web/20081220052431/http://dnssec-deployment.org/][DNSSEC Home Page December 2008]]
- [[https://dnssec-tools.org/][DNSSEC-Tools]]
...
[[https://www.ipv6forum.com/][The IPv6 Forum Releases The IPv6 Security (IPsec) Ready Logo Program]]
...
7. [[https://tldp.org/LDP/nag2/x-087-2-resolv.html][Name Service and Resolver Configuration]]
8. [[https://www.verisign.com/en_US/domain-names/dnssec/index.xhtml][The Development Of The DNSSEC]]
9. [[https://en.wikipedia.org/wiki/IPv6][IPv6 - Wikipedia]]
10. [[https://tldp.org/HOWTO/Linux+IPv6-HOWTO/index.html][Linux IPv6 HOWTO (en)]]
11. [[https://phoenixnap.com/kb/linux-dig-command-examples][How to Use Linux dig Command (DNS Lookup)]]
12. [[https://www.geeksforgeeks.org/host-command-in-linux-with-examples/][host command in Linux with examples]]
13. [[https://www.geeksforgeeks.org/nslookup-command-in-linux-with-examples/][nslookup command in Linux with Examples]]
