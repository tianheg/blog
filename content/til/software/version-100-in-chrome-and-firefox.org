...
#+HEADER: Tools
1. [[https://hacks.mozilla.org/2022/02/version-100-in-chrome-and-firefox/][Version 100 in Chrome and Firefox - Mozilla Hacks - the Web developer blog]]
2. [[https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/User-Agent][User-Agent - HTTP | MDN]]

​## User-Agent string

[[https://www.rfc-editor.org/rfc/rfc7231.html#section-5.5.3][User-Agent (UA)]] 是一个字符串，放在浏览器发送给服务器的 HTTP 请求头中，它的作用是使服务器能够识别对应的浏览器。

它也可以通过 JS 使用 [[https://developer.mozilla.org/en-US/docs/Web/API/Navigator/userAgent][navigator.userAgent]] 获得。
