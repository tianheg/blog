...
title: '配置imgproxy'
status: draft
date: 2025-11-30T22:12:49+08:00
header: DevOps
---

Railway的bucket目前还没有提供公开可访问的功能，所以需要自己想办法支持，[imgproxy](https://imgproxy.net/)就是一个方案。完整的模板在[public-bucket-image-proxy](https://railway.com/deploy/public-bucket-image-proxy)。
