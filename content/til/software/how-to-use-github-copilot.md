...
"我需要一个 ts 类，他的使用方式和调用方式是：[伪代码](https://m.tianheg.org/%E4%BC%AA%E4%BB%A3%E7%A0%81)，帮我实现一个最基础的版本" "I need a TypeScript class with usage and invocation methods as follows: pseudocode. Help me implement a basic version."
...
### AI 时代的代码质量观（子龙山人）
- 代码质量与谁写（人写还是 AI 写）无关，取决于三件事：人的经验是否丰富、需求是否准确、架构设计是否合理。这三点满足，人定义好、AI 直接执行，质量一样好，效率是人的 10 倍以上
- 真正的代码质量是全局思维：是否用最简单的设计满足用户需求？数据流向是否清晰？性能瓶颈是否恰当解决？不只是规范、去重这些表面功夫
- 很多人不用 AI，不是 AI 不强大，是迷恋手写代码的掌控感和优越感。那些"代码的小秘密"（经验 trick）在 AI 时代已无意义
- 人机协作的正确姿势：人脱离工作量束缚后，应专心读底层/原理的书、精力充沛地做架构设计。更清晰的业务逻辑、架构设计、更快满足用户需求，才是 AI 时代人真正要精进的地方

来源: [AI 时代真正的代码质量与人机协作](https://manateelazycat.github.io/2026/08/04/ai-code-quality-and-collaboration/)
