---
title: 'Open Missing Semester of Cs'
status: draft
...
Lesson 4.1: CURSOR LOCATION AND FILE STATUS CTRL-G 显示光标所在行、文件状态 G 来到文件最后一行 gg 来到文件第一行 `num + G` 跳到目标行 > Type the number of the line you were on and then G. This will return you to the line you were on when you first pressed CTRL-G. 
