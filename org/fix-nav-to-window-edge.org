...
[[https://images.yidajiabei.xyz/fix-nav-to-window-edge-0.png]]
[[https://images.yidajiabei.xyz/fix-nav-to-window-edge-1.png]]

两张照片的区别在于，后者的 =z-index=，=background-color=
都被注释掉。显而易见导航栏和正文内容交叠在一起，看起来不够简洁。

[[https://images.yidajiabei.xyz/fix-nav-to-window-edge-2.png]]
[[https://images.yidajiabei.xyz/fix-nav-to-window-edge-3.png]]
...
[[https://images.yidajiabei.xyz/fix-nav-to-window-edge-4.png]]
[[https://images.yidajiabei.xyz/fix-nav-to-window-edge-5.png]]
