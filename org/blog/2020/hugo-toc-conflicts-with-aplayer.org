...
正常情况下，点击每篇文章前生成的目录，是能够跳转到对应位置的。现在不行了。我猜测可能是
[[https://github.com/metowolf/MetingJS][MetingJS]] 的问题，于是找它的
issues ，终于找到了
[[https://github.com/metowolf/MetingJS/issues/5][它]] 。而这个问题指向了
APlayer。因为 MetingJS 就是基于 APlayer 开发的。
...
#+begin_quote
  ...
  导致的，它给 hashtag 链接的 click 事件增加了 listener
  ，但是却不能正确处理含有中文的 hashtag 链接（因为 url 编码）。这玩意儿
  17 年到现在都没更新过，也难怪。
  ...
  ------[[https://github.com/MoePlayer/APlayer/issues/242#issuecomment-602471423][该回答]]
  出自 [[https://github.com/ZeppLu][ZeppLu]]
#+end_quote
