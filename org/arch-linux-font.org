...
#+DATE: <2022-09-06 Tue 08:37>
#+HUGO_TAGS: 技术 "Arch Linux"

文章基于《[[/posts/arch-software-installation-and-usage/][Arch Linux 软件安装和用法]]》的字体一节进行扩展。
...
对于 Web 字体，可通过 CSS 中的 [[https://developer.mozilla.org/en-US/docs/Web/CSS/font-feature-settings][font-feature-settings]] 开启 stylistic set。
