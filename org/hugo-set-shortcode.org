...
** align
   ...
   :CUSTOM_ID: align
   :END:
对文字进行居中、居左、居右的设置。在 =~/layouts/shortcodes/= 下创建
=align.html=，内容如下：
...
你需要在简码中填写仓库名 =name=，仓库链接 =link=，仓库描述
=description=，代码语言 =language=，代码语言对应的颜色 =color=。
...
** gallery
   ...
   :END:
#+begin_example
  {{</* gallery dir="https://images.yidajiabei.xyz/friends/" />}} {{< load-photoswipe */>}}
  # 这是添加组合图片的短代码
#+end_example
...
{{< quote en >}} /We don't read and write poetry because it's cute. We
read and write poetry because we are members of the human race. And the
human race is filled with passion./ {{< /quote >}}
...
1. [[https://guanqr.com/tech/website/hugo-shortcodes-customization/][自定义
   Hugo Shortcodes 简码]]
2. [[https://hugoloveit.com/zh-cn/theme-documentation-extended-shortcodes/][主题文档 -
   扩展 Shortcodes]]
