...
可以在 [[https://v3.vuejs.org/api/application-api.html][API reference]] 找到全部的应用 API。
...
#+BEGIN_EXPORT html
<img src="https://v3.vuejs.org/images/lifecycle.svg" style="display: block;margin: auto;">
#+END_EXPORT